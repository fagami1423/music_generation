...
def sample(model_name: str,
  ...
  # midi_file = './sample/output.mid'
  # midi_data.write(sample_sequences, midi_file)
  # pretty_midi = mm.midi_io.note_sequence_to_pretty_midi(sample_sequences)
  # plotter = Plotter()
...
def interpolate(model_name: str,
  ...
  # saved_midi =  note_sequence_to_midi_file(interpolate_sequences, '/Music_VAE/output/tets.mid')
